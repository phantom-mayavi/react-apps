  ...
  render() {
    return (
      <div>
        ...
        <div class="container" >
            {/* <br/> */}
          <div class="container" class=" contact-background-image" style={{ paddingRight: "70px" }}>
            ...
            <div class="row">
              <div class="col-md-4">
                <p>
                  ...
                  iusto ex, veritatis repellat consequatur excepturi labore iste
                  natus magni nesciunt unde vitae nam, odio tenetur explicabo,
                  minus perferendis. Dolorem, quibusdam.
                </p>
              </div>
            </div>
          </div>
              ...
              <div class="col-md-6">
                <div>
                  ...
                  <p>
                    ...
                    aliqua. Semper viverra nam libero justo laoreet sit amet
                    cursus sit. Risus sed vulputate odio ut. Ultricies mi eget
                    mauris pharetra et.
                  </p>
                </div>
              </div>
              <div class="col-md-6">
                <div>
                  ...
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                    do eiusmod tempor incididunt ut labore et dolore magna
                    aliqua. Imperdiet sed euismod nisi porta lorem. Commodo
              ...
              <div class="col-md-6">
                <div>
                  ...
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                    do eiusmod tempor incididunt ut labore et dolore magna
                    aliqua. Vitae justo eget magna fermentum iaculis eu non diam
                    phasellus.
                  </p>
                </div>
              </div>
